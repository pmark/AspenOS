...
public class MultipartRequest {
  ...
  public MultipartRequest(ServletRequest request,
                          String saveDirectory, LoggerWrapper log) 
	  		throws IOException {
    this(request, saveDirectory, DEFAULT_MAX_POST_SIZE, log);
    this.lw = log;
  }
  ...
  public MultipartRequest(ServletRequest request,
                          ...
                          int maxPostSize, LoggerWrapper log) 
	  		throws IOException {
    this.lw = log;
...
System.out.println("MPR line: " + line);
